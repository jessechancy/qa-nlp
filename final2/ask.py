...
class Questions():
    ...
    def wh_questions_from_tree(self, parsed_tree):
        ...
        for ent in doc.ents:
            ...
            prev = label
            if label == 'ORG':
                question.append("What " + str(vpWord) + "?")
            elif label == 'PERSON':
                question.append("Who " + str(vpWord) + "?")
            elif label == 'NORP':
                if plural:
                    question.append("Which groups " + str(vpWord) + "?")
                else:
                    question.append("Which group " + str(vpWord) + "?")
            elif label == 'TIME' or label == 'DATE':
                question.append("When " + str(vpWord) + "?")
            elif label == 'GPE':
                if plural:
                    question.append("Which bodies " + str(vpWord) + "?")
                else:
                    question.append("Which body " + str(vpWord) + "?")
